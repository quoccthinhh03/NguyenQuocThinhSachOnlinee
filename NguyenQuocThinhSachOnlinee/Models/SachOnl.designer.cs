...
namespace NguyenQuocThinhSachOnlinee.Models
{
    ...
    partial void DeleteVIETSACH(VIETSACH instance);
		...
		public SachOnlDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SachOnlDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
